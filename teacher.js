...
const LEVEL_MAP = {
  1:  { name: 'Intro to AI & ML',         level: 'beginner' },
  2:  { name: 'Python for AI',             level: 'beginner' },
  3:  { name: 'Math for AI',               level: 'beginner' },
  4:  { name: 'Data Basics',               level: 'beginner' },
  5:  { name: 'Data Preprocessing',        level: 'intermediate' },
  6:  { name: 'EDA',                       level: 'intermediate' },
  7:  { name: 'Supervised ML',             level: 'intermediate' },
  8:  { name: 'Unsupervised ML',           level: 'intermediate' },
  9:  { name: 'Feature Engineering',       level: 'intermediate' },
  10: { name: 'Deep Learning',             level: 'advanced' },
  11: { name: 'Computer Vision',           level: 'advanced' },
  12: { name: 'NLP',                       level: 'advanced' },
  13: { name: 'Reinforcement RL',          level: 'advanced' },
  14: { name: 'Generative AI',             level: 'expert' },
  15: { name: 'MLOps',                     level: 'expert' },
  16: { name: 'AI Ethics',                 level: 'expert' },
  17: { name: 'Capstone Projects',         level: 'expert' },
};
